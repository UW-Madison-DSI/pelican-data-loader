...
# Main content area
tab_labels = ["📁 File Upload", "📋 Dataset Info", "📄 Generate Metadata", "📢 Publish to UW-Madison Data Repo"]

# Create the tabs in the UI
upload_tab, dataset_info_tab, generate_tab, publish_tab = st.tabs(tab_labels)
