...
def main():
    parser = argparse.ArgumentParser(description="Pull license data from SPDX.org")
    parser.add_argument("--output", default="licenses.jsonl", help="Output path for the license data")
    args = parser.parse_args()

    print("Pulling license data from SPDX.org...")
    pull_license(output_path=args.output)
    print("Done.")
